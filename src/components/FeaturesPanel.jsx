export const FeaturesPanel = ({ title, text, img }) => {
	return (
		<div className='flex flex-col py-5 md:flex-row md:space-x-7 panel panel-1'>
			<div className='flex justify-center md:w-1/2'>
				<img src={img} alt='tab1' className='relative z-10' />
			</div>
			<div className='flex flex-col space-y-8 md:w-1/2'>
				<h3 className='mt-32 text-3xl font-semibold text-center md:mt-0 md:text-left'>{title}</h3>
				<p className='max-w-md text-center text-grayishBlue md:text-left'>{text}</p>
